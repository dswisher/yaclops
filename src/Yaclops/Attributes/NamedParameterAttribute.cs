...
namespace Yaclops.Attributes
{
    ...
    public class NamedParameterAttribute : Attribute
    {
        ...
        /// </summary>
        [Obsolete("Use the ShortName attribute instead, which allows multiple names to be specified.")]
        public string ShortName { get; set; }

        /// <summary>
        /// The long name for the parameter. The default is the decamel of the property name.
        /// </summary>
        [Obsolete("Use the LongName attribute instead, which allows multiple names to be specified.")]
